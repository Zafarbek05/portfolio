  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor: `background: rgb(0,0,0),
background: linear-gradient(90deg, rgba(0,0,0,1) 0%, rgba(31,31,31,1) 36%, rgba(69,79,82,1) 58%, rgba(149,157,158,1) 84%, rgba(177,184,183,1) 100%)`,
      }}
    >
